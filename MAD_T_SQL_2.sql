...
tel_cel bigint null,
CONSTRAINT con_pkusu PRIMARY KEY( clave_usuario,no_nomina     )
);
...
fecha_ini datetime,
clave_pais INT FOREIGN KEY REFERENCES pais(clave_pais),
clave_usuario INT FOREIGN KEY REFERENCES usuario (clave_usuario , no_nomina),
